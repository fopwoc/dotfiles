...
case $OS in
  Darwin)
    ...
    brew install exa autojump fd fzf vim fortune cowsay htop tmux tldr httpie ncdu
    ;;
  ...
  Linux)
    ...
    if [[ $distro == *"Ubuntu"* ]]; then
      sudo apt -y install autojump fd-find fzf vim fortune cowsay htop tmux ncdu httpie pip
      pip install tldr
